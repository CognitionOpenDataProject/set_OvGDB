...
**NOTE we initially encounterd an error for low blame (commented out above): it appears that the authors reported percent greater than or equal midpoint, instead of greater than. An author confirmed this was the case - the article should have said greater than or equal to midpoint, as below:**
...
The first large numerical error is related to the percent of people in the Low Blame condition who were above DV midpoint. The likely cause is that the authors accidently reported the percent of people greater than **or equal to** the midpoint for Low Blame, instead of those greater than the midpoint.  NB - authors have confirmed this.
